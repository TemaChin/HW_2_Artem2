...
extension MyViewController {
    ...
    func myNameLabelSetup() {
        ...
        myNameLabel.attributedText = NSAttributedString(string: nameMain, attributes: [NSAttributedString.Key.foregroundColor : UIColor.blue, NSAttributedString.Key.font : UIFont(name: "Helvetica", size: 20) as Any])
    ...
    func myCityLabelSetup() {
        ...
        myCityLabel.attributedText = NSAttributedString(string: cityMain, attributes: [NSAttributedString.Key.font : UIFont(name: "Helvetica", size: 15) as Any, NSAttributedString.Key.foregroundColor : UIColor.blue])
        NSLayoutConstraint.activate([
